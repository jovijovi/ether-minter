 ...
 *   ╚═════╝ ╚═╝      ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝╚═════╝ ╚══════╝╚══════╝
 *
 *  AvatarUpgradeable Contract v0.4.0
 *  Dependencies:
...
import "./PermissionUpgradeable.sol";

/**
 * @title An avatar NFT contract.
 */
contract AvatarUpgradeable is ERC721AUpgradeable, ERC721AQueryableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PermissionControlUpgradeable {
    /* *******
     * Globals
     * *******
     */
