...
describe("NFT Contract", function () {
	...
	const contractName = "AvatarUpgradeable";
	...
	async function attachContract(name: string, address: string): Promise<AvatarUpgradeable> {
		const contractFactory: AvatarUpgradeable__factory = await ethers.getContractFactory(name) as AvatarUpgradeable__factory;
	...
	async function connectContract(address: string): Promise<AvatarUpgradeable> {
		return AvatarUpgradeable__factory.connect(contractAddress, await ethers.getSigner(address));
	}
